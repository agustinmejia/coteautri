...
(function(window) {
  ...
  Player = function(playerNode) {
    ...
    extras = {
      loadFailedCharacter: '<span title="Problemas al cargar/reproducir." class="load-error">✖</span>'
    };
    ...
    function PlaylistController() {
      ...
      function select(item) {
        ...
        if (item) {
          ...
          liElement = utils.dom.ancestor('tr', item);
...
//Efecto de corazón favoritos en el player
$(document).ready(function(){
    $('#btnFavPlayer').click(function(){
        $('#btnFavPlayer i').toggleClass('faved');
